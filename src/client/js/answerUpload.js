const answerBox = document.querySelector('.answer-upload');
const canvas = answerBox.querySelector('.answer-canvas');
const finishAnswerBtn = answerBox.querySelector('.answer-upload__finish-btn');
